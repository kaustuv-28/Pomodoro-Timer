...
class PomodoroTimer:
    ...
    def __init__(self):
        ...
        self.s=ttk.Style()
        self.s.configure("TNotebook.Tab", font=("Helvetika", "16", "bold"))
        self.s.configure("TButton", font=("Helvetika", "16", "bold"))
        ...
        self.pomodoro_timer_label = ttk.Label(self.tab1, text="25:00", font=("Helvetika", "42", "bold"))
        self.pomodoro_timer_label.pack(pady=20)
        
        self.short_break_timer_label = ttk.Label(self.tab2, text="05:00", font=("Helvetika", "42", "bold"))
        self.short_break_timer_label.pack(pady=20)   
        
        self.long_break_timer_label = ttk.Label(self.tab3, text="15:00", font=("Helvetika", "42", "bold"))
        ...
        self.reset_button = ttk.Button(self.grid_layout, text="Reset", command=self.skip_clock)
        self.reset_button.grid(row=0, column=2)
        
        self.pomodoro_counter_label = ttk.Label(self.grid_layout, text="Pomodoros: 0", font=("Helvetika", "16"))
